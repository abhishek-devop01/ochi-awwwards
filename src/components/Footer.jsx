...
const Footer = () => {
  return (
    <div data-scroll data-scroll-section data-scroll-speed=".2" className="w-full h-screen bg-zinc-900 flex p-20">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[6vw] uppercase leading-none font-black -mb-3">
            Eye-
          </h1>
          <h1 className="text-[6vw] uppercase leading-none font-black -mb-3">
            Opening
